...
public:
  ...
  // Constructor:
  ssr_fft_fp_c_dcm_stream(int (&fftbuf_i)[2048], int (&lut2)[64], int (&lutexp_i)[128], int (&exp_buff)[128]);
  ...
  {
    REGISTER_FUNCTION( ssr_fft_fp_c_dcm_stream::run );
