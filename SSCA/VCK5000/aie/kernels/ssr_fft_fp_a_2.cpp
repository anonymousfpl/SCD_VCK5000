...
ssr_fft_fp_a_2::ssr_fft_fp_a_2(int (&winbuff0_i)[1024], int (&winbuff1_i)[1024], int (&window_coeff_i)[64])
...
void ssr_fft_fp_a_2::run( input_buffer_1d<int,1024,0>& __restrict inputx0,
